...
public class MessageProvider
{
    public static Message getIputMissing() {
        return new Message(Alert.AlertType.ERROR,
                "Downloads folder doesn't exist, please set correct path and try again.", "Input Path Error");
    }

    public static Message getOutputMissing() {
        return new Message(Alert.AlertType.ERROR,
                "Movies or TvShows folder/s not set, please set correct paths and try again.", "Output Path Error");
    }

    public static Message getNothingSelected() {
        return new Message(Alert.AlertType.INFORMATION,
                "No video files have been selected, nothing was moved...", "No Move Done");
    }

    public static Message getProblemOccurred() {
        return new Message(Alert.AlertType.WARNING, "Problem occurred while moving, some files might not have been moved, please check", "Move Error Detected");
    }

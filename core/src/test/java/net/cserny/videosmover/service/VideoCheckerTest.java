...
public class VideoCheckerTest {
    ...
    public void isVideo_parsingDirectoryReturnsFalse() throws Exception {
        ...
        assertFalse(isVideoResult(StaticPathsProvider.getJoinedPathString(videoPath, videoFolder)));
    }
    ...
    public void isVideo_parsingNonVideoFileReturnsFalse() throws Exception {
        ...
        assertFalse(isVideoResult(StaticPathsProvider.getJoinedPathString(videoPath, videoFolder, videoFile)));
    }
    ...
    public void isVideo_parsingVideoFileReturnsTrue() throws Exception {
        ...
        assertTrue(isVideoResult(StaticPathsProvider.getJoinedPathString(videoPath, videoFolder, videoFile)));
    }

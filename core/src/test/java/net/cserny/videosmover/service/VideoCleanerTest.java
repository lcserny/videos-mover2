...
//
//public class VideoCleanerTest extends InMemoryFileSystem {
//
//    @Inject
...
//        Video video = VideoResolver.resolveMovie(DOWNLOADS_ROOT_VIDEO, outputResolver::resolve);
//        assertCleaning(video, false);
//    }
//
//    @Test
//    public void clean_whenRestrictedPathThenDoNotClean() throws Exception {
//        Video video = VideoResolver.resolveMovie(DOWNLOADS_RESTRICTED_MOVIE, outputResolver::resolve);
//        assertCleaning(video, false);
//    }
//

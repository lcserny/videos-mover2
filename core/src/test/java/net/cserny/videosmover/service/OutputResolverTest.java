...
public class OutputResolverTest {
    ...
    public void resolve_allDigitsMovieResolvesNameCorrectly() throws Exception {
        ...
        Video video = VideoResolver.resolveMovie(StaticPathsProvider.getPathString(false, moviePath, movieFolder, movieFile),
    ...
    public void resolve_tvShowInputReturnsCorrectOutput() throws Exception {
        ...
        Video video = VideoResolver.resolveTvShow(StaticPathsProvider.getPathString(false, tvPath, tvFolder, tvFile),
                outputResolver::resolve);
    ...
    public void resolve_movieInputReturnsCorrectOutput() throws Exception {
        ...
        Video bigSick = VideoResolver.resolveMovie(StaticPathsProvider.getPathString(false, bigSickPath, bigSickFolder, bigSickFile),
                outputResolver::resolve);
        ...
        Video acrimony = VideoResolver.resolveMovie(StaticPathsProvider.getPathString(false, acrimonyPath, acrimonyFolder, acrimonyFile),
                outputResolver::resolve);
    ...
    public void resolve_tvShowInputSetsOutputToExistingTvShowName() throws Exception {
        ...
        Video criminalMinds = VideoResolver.resolveTvShow(StaticPathsProvider.getPathString(false, criminalMindsPath, criminalMindsFolder, criminalMindsFile),
                outputResolver::resolve);
        ...
        Video chicagoPd = VideoResolver.resolveTvShow(StaticPathsProvider.getPathString(false, chicagoPdPath, chicagoPdFolder, chicagoPdFile),
                outputResolver::resolve);
        ...
        Video chicagoMed = VideoResolver.resolveTvShow(StaticPathsProvider.getPathString(false, chicagoMedPath, chicagoMedFile),
                outputResolver::resolve);
    ...
    public void resolve_tvShowWithSeasonInName() throws Exception {
        ...
        Video houseOfCards = VideoResolver.resolveTvShow(StaticPathsProvider.getPathString(false,
        ...
        Video houseOfCards2 = VideoResolver.resolveTvShow(StaticPathsProvider.getPathString(false,

...
//
//public class VideoMoverTest extends InMemoryFileSystem {
//
//    @Inject
...
//        Video video1 = VideoResolver.resolveTvShow(DOWNLOADS_TVSHOW, outputResolver::resolve);
//        Video video2 = VideoResolver.resolveTvShow(DOWNLOADS_EXISTING_TVSHOW, outputResolver::resolve);
...
//        Video video = VideoResolver.resolveMovie(DOWNLOADS_MOVIE_WITH_SUBTITLE, outputResolver::resolve);
...
//        Video video = VideoResolver.resolveMovie(DOWNLOADS_MOVIE_WITH_SUBTITLE_IN_SUBS, outputResolver::resolve);

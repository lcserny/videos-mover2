package net.cserny.videosmover.javafx.controller;
...
import net.cserny.videosmover.javafx.component.CustomTextFieldCell;
import net.cserny.videosmover.javafx.component.RadioButtonTableCell;
import net.cserny.videosmover.javafx.facade.MainFacade;
...
import static net.cserny.videosmover.core.helper.LoadingService.MOVE_LOADING_KEY;
import static net.cserny.videosmover.core.helper.LoadingService.SCAN_LOADING_KEY;
import static net.cserny.videosmover.core.service.thread.TwoThreadsExecutor.doInAnotherThread;
